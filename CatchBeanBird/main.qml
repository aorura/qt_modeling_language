...
Window {
    ...
    maximumHeight/* fill the blank */: 320; maximumHeight: 420;
    ...
    Flipable {
       ...
       /* fill the blank */: Rectangle {
            ...
            Grid {
                id: board
                columns: 5
                /* fill the blank */ { top: parent.top; right: parent.right; left: parent.left; 
                               margins: 10 }
            }
        ...
        states: /* fill the blank */ {
            name: "back"
            /* fill the blank */ { target: rotation; angle: 180 }
            /* fill the blank */: mainRect.flipped
        }
        transitions: /* fill the blank */ {
            /* fill the blank */ { target: rotation; property: "angle"; duration: 500 }
        }
        ...
        Timer {
            ...
            repeat: false
            onTriggered: {
                playMusic./* fill the blank */();
                endSound./* fill the blank */();
